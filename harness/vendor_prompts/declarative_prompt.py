# VENDORED VERBATIM from github.com/joyheyueya/declarative-math-word-problem
#   path: prompts/declarative_three_shot.py
#   commit: main @ retrieved 2026-09-08 (repo has no tags; single-branch)
# Unmodified. run.py uses DECLARATIVE_THREE_SHOT_AND_PRINCIPLES with
#   max_tokens=600, stop_token="\n\n\n", temperature=0.
