# VENDORED from github.com/joyheyueya/declarative-math-word-problem  (utils.py)
#   commit: main @ retrieved 2026-09-08
# Functions copied unmodified EXCEPT: added `import string` (the original file relies
# on `string` being in scope via `from ... import *` elsewhere; get_final_using_sympy
# references string.ascii_lowercase). No logic changed.
import string
import numpy as np
